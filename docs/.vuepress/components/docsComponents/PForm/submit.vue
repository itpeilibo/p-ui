    ...
    return {
      ...
      formOpts: {
        ...
        fieldList: [
          ...
          { label: '性别', value: 'sex', placeholder: 'PSelect单选', isSelfCom: true, comp: 'p-select', bind: { valueKey: 'value' } },
          { label: '状态', value: 'status', placeholder: 'PSelect单选', isSelfCom: true, comp: 'p-select', bind: { valueKey: 'value' } },
          { label: '爱好', value: 'hobby', placeholder: 'PSelect多选', isSelfCom: true, comp: 'p-select', list: 'hobbyList', bind: { multiple: true, valueKey: 'value' } },
