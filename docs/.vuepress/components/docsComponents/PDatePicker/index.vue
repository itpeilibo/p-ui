<template>
  <div class="p-date-picker-demo">
    <div class="box_content">
      <div class="box_flex">
        <div>选择日</div>
        <p-date-picker v-model="date" @change="change($event,'date','date')" />
      </div>
      <div class="box_flex">
        <div>选择周</div>
        <p-date-picker v-model="date1" type="week" @change="change($event,'week','date1')" />
      </div>
      <div class="box_flex">
        <div>选择月</div>
        <p-date-picker v-model="date2" type="month" @change="change($event,'month','date2')" />
      </div>
      <div class="box_flex">
        <div>选择年</div>
        <p-date-picker v-model="date3" type="year" @change="change($event,'year','date3')" />
      </div>
    </div>
    <div class="box_content">
      <div class="box_flex">
    ...
    <div class="box_content">
      <div class="box_flex">
        <div>选择日期&时间</div>
        <p-date-picker v-model="date8" type="datetime" @change="change($event,'datetime','date8')" />
      </div>
      <div class="box_flex">
