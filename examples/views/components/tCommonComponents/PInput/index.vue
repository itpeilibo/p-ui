  ...
  <div class="p-input">
    <p-layout sectionTitle="input组件">
      <div class="content-main p-margin20">
        ...
        <p-input placeholder="请输入金额" isTip v-model="money2"></p-input>
        <div>显示天数</div>
        <p-input
          placeholder="请输入天数"
          inputType="days"
        ...
        ></p-input>
        <div>显示百分比</div>
        <p-input placeholder="请输入" inputType="percent" appendTitle="%" v-model="percent"></p-input>
        <div>显示电话号码</div>
        <p-input
          placeholder="请输入电话号码"
          :isShow="false"
