<template>
  <div class="excel-upload" style="width: 100%;">
    <p-layout sectionTitle="Excel上传组件">
      <p-step-wizard
      ...
      >
        ...
        <template #first>
          <div class="content-main">
            ...
            />
            <div class="hint p-margin-top-10">
              <i class="i-icon icon iconfont icon-prompt p-padding5 text-primary" />&nbsp;
              <b>提示：</b>
...
<script>
import PUploadExcel from '../../../../packages/upload-excel'
export default {
  name: 'excelUpload',
  components: { PUploadExcel },
  data () {
    return {
      active: 0,
      stepData: [
