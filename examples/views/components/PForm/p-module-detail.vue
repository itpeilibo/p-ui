<template>
  <div class="p-module-detail-demo">
    <p-layout sectionTitle="模块详情组件运用" :isShowTitle="false">
      <div class="content-main">
        ...
        >
          <!-- tabs插槽 -->
          <template #tab1>
            <p-table title="常规表格" :table="baseData.table" :columns="baseData.columns" />
          </template>
          <template #tab2>
            <div>指派明细</div>
          </template>
