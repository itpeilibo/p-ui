<template>
  <div class="p_table_demo">
    <p-layout sectionTitle="TTable组件运用">
        ...
        <p-layout-page>
          ...
          <p-layout-page-item>
            ...
            <div class="base">
              ...
              />
              <p-table title="双击单元格复制" :table="baseData.table" :columns="baseData.columns" isCopy />
              <p-table title="文字变色" :table="changeColor.table" :columns="changeColor.columns" />
              <p-table
                title="显示分页器"
                :table="baseData.table"
                :columns="baseData.columns"
          ...
          <p-layout-page-item>
            <h1>按钮操作</h1>
            <div class="operator">
              <p-table title="表格内操作" :table="operatorData.table" :columns="operatorData.columns" />
              <p-table
                title="表格外操作"
                highlightCurrentRow
