<template>
  <p-layout-page>
    <p-layout-page-item>
      ...
      >
        <p-form :ref-obj.sync="formOpts.ref" ref="dialogForm" :formOpts="formOpts" :widthSize="1" />
    ...
    return {
      ...
      formOpts: {
        ...
        fieldList: [
          ...
          { label: '性别', value: 'sex', placeholder: 'PSelect单选', type: 'select-arr', comp: 'p-select', bind: { valueKey: 'value' } },
          { label: '状态', value: 'status', placeholder: 'PSelect单选', type: 'select-arr', comp: 'p-select', bind: { valueKey: 'value' } },
          { label: '爱好', value: 'hobby', placeholder: 'PSelect多选', type: 'select-arr', comp: 'p-select', list: 'hobbyList', bind: { multiple: true, valueKey: 'value' } },
