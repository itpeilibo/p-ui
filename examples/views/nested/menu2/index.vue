      ...
      >
        <template #first>
          <div class="content-main" style="margin-bottom: 80px;">
            ...
            <div class="list-group p-margin-top-10">
              <div class="list-group-item">
                <t-table
                  :table="table1"
                  :columns="columns1"
            ...
            <div class="list-group p-margin-top-20">
              <div class="list-group-item">
                <el-form
                  :model="ruleForm"
                  :rules="rules"
                  ref="ruleForm"
                  label-width="100px"
                  class="demo-ruleForm p-margin-top-20"
                >
                  <el-form-item label="活动名称" prop="name">
                    <el-input clearable v-model="ruleForm.name"></el-input>
                  </el-form-item>
                  <el-form-item label="金额" prop="money">
                    <p-input placeholder="请输入金额" v-model="ruleForm.money"></p-input>
                  </el-form-item>
